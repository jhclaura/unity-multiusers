...
console.log("thisIsTouchDevice: " + thisIsTouchDevice);
...
THREE.DeviceControls = function ( camera, worldCenter ) {
	...
	this.update = function ( delta ) {
		...
		// so need to update SELF player position here
		dailyLifePlayerDict[ whoIamInLife ].update( 
			yawObject.position.x, yawObject.position.y, yawObject.position.z, eyeFinalQ2 
		);
		////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////
